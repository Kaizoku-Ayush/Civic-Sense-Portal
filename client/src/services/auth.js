...
export const getAuthErrorMessage = (error) => {
  const errorMessages = {
    ...
    'auth/missing-continue-uri': 'Password reset is not configured correctly. Please contact support.',
    'auth/invalid-continue-uri': 'Password reset link configuration is invalid. Please contact support.',
    'auth/unauthorized-continue-uri': 'This reset link domain is not authorized. Please contact support.',
